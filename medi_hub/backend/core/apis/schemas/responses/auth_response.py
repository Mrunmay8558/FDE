...
class UserAuthResponse(BaseModel):
    """Represents the user data returned after a successful signup.
    ...
    Attributes:
        ...
        access_token: JWT access token issued after signup.
    """
...
class SignupResponse(BaseModel):
    """Represents the API response returned after successful user signup.

    Attributes:
        message: Human-readable success message.
        user: Serialized user payload returned to the client.
    """

    message: str = Field(..., description="Success message for the signup request")
    user: UserAuthResponse = Field(..., description="Created user details")
